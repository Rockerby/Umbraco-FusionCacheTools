...
REM dotnet new install Umbraco.Templates::10.7.0
dotnet new umbraco --version "10.7.0" -n FusionCacheTools.TestSite --friendly-name "Administrator" --email "admin@example.com" --password "1234567890" --development-database-type SQLite
